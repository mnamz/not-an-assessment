        ...
        <div class="py-3 px-6">
            <div class="flex flex-col">
                <div class="py-4 flex justify-end ">
                    ...
                    <PrimaryButton class="mb-3 dark:!bg-blue-500 text-white hover:bg-blue-400 "> Add Product
                    </PrimaryButton>
                    </Link>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="dark:bg-gray-700 divide-y text-white divide-gray-200 ">
                            <tr v-for="item in products" :key="item.id">
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ item.name }}</td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ item.restaurant.name }}</td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ item.price }}</td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ item.details }}</td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ item.created }}</td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <button @click="deleteEntry(item.id)" v-if="item.deleted_at == null"
                                            class="inline-flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"

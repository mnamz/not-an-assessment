...
<template>
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="restaurant" value="Restaurant Name" />
                <TextInput id="restaurant" v-model="form.restaurant" type="text" class="mt-1 block w-full" required
                    autofocus autocomplete="restaurant" />
                <InputError class="mt-2" :message="form.errors.restaurant" />
            </div>
            ...
            <div class="mt-4">
                ...
                <TextInput id="categories" v-model="form.categories" type="text" class="mt-1 block w-full" required
                    autofocus autocomplete="categories" placeholder="Enter categories separated by commas" />
